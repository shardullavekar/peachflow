...
public class MainActivity extends AppCompatActivity {
  ...
  private void callPeachPayments(String amount, String currency, String type, String env) {
    ...
    private void initListener() {
        peachListener = new PeachListener() {
            ...
            public void onFailure(int code, String reason) {
                Toast.makeText(getApplicationContext(), "Failed Reason:" + reason, Toast.LENGTH_LONG).show();
            }
        };
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callPeachPayments("95.00", "EUR", "DB", Config.TEST);//calling this initiates payment
//      change payment type from Preauthorization to Debit by changing argument from "PA" to "DB" e.g. callPeachPayments("95.00", "EUR", "DB", Config.TEST);
    }
}
