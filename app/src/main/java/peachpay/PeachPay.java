...
import devsupport.ai.flowpeach.R;
...
public class PeachPay extends AppCompatActivity {
    ...
    private void configCheckout(String checkoutId) {
        ...
        checkoutSettings.setSecurityPolicyModeForBrand("VISA", CheckoutSecurityPolicyMode.DEVICE_AUTH_REQUIRED_IF_AVAILABLE);
        checkoutSettings.setSecurityPolicyModeForTokens(CheckoutSecurityPolicyMode.DEVICE_AUTH_REQUIRED_IF_AVAILABLE);
        ...
        switch (resultCode) {
            ...
            /* transaction completed */
                ...
                /* check the result of synchronous transaction */
                    fireBroadcast(Config.SUCCESS, "checkoutId=" + checkoutId + ":resourcepath=" + resourcePath);
                } else {
